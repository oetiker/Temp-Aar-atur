...
// Re-export organized constants for backward compatibility
export 'ui_constants.dart';
export 'api_constants.dart';
export 'chart_constants.dart';

/// Legacy AppConstants class for backward compatibility
/// New code should use context-specific constant classes instead
class AppConstants {
  // Timer intervals (use ApiConstants instead)
  static const Duration dataRefreshInterval = Duration(seconds: 700);
  
  // Progressive data loading intervals (use ApiConstants instead)
  static const Duration initialDataPeriod = Duration(hours: 1);
  static const Duration chartDataPeriod = Duration(days: 7);
  static const Duration extendedDataPeriod = Duration(days: 30);
  static const Duration fullDataPeriod = Duration(days: 365);
  
  // Animation durations (use UiConstants instead)
  static const Duration pageTransitionDuration = Duration(milliseconds: 300);
  
  // Colors (use UiConstants instead)
  ...
  // UI sizes (use UiConstants instead)
  ...
  // Temperature circle sizing factors (use ChartConstants instead)
  ...
  // Positioning offsets (use UiConstants instead)
  ...
  // Chart text sizes (use ChartConstants instead)
  ...
  // Chart layout (use ChartConstants instead)
  ...
  // Padding and margins (use UiConstants instead)
